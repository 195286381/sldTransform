...
function genGridSLDRootJSONObj(propertyName, divisionNum, divisionAry, colorAry, sldNameAry, sldAbstractAry) {
    var params = {
    ...
    return {
        'sld:StyledLayerDescriptor': [
            ...
            genSLDNamedLayerJSONObj(propertyName, divisionNum, divisionAry, colorAry, sldNameAry, sldAbstractAry)
        ]
    };
}
